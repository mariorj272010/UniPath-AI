 ...
 * Drifts slowly, parallaxes to the pointer, dims when the tab is hidden,
 * and renders a single static frame under prefers-reduced-motion.
 */
export function Atmosphere({ fixed = true }: { fixed?: boolean }) {
  ...
  return (
    ...
    >
      <div
        className="anim-aurora absolute -left-[10%] top-[-15%] h-[70vh] w-[70vw] rounded-full opacity-70 blur-[120px]"
        style={{ background: "radial-gradient(circle, oklch(0.62 0.13 56 / 0.32), transparent 65%)" }}
      />
      <div
        className="anim-aurora absolute right-[-15%] top-[30%] h-[60vh] w-[60vw] rounded-full opacity-50 blur-[130px]"
        style={{
          background: "radial-gradient(circle, oklch(0.5 0.08 220 / 0.3), transparent 60%)",
          animationDelay: "-8s",
        }}
      />
            ...
            style={
              {
                ...
                background: "linear-gradient(to bottom, oklch(0.86 0.13 78 / 0.14), transparent 70%)",
